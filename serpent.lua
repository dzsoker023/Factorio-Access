---@diagnostic disable
--[[
Copy of serpent, formatted with stylua. See
https://github.com/pkulchenko/serpent

Factorio has this in game. It is very helpful to have it out of the game for
testing by hand.  Installing Lua libraries is a pain, so let's just grab a copy.
]]
